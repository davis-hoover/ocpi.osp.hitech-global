...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0x7BFFFFFFU ,0x50040000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0x7BFFFFFFU, 0x50040000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180140, 0x03FFFFFFU ,0x03F7EF5EU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL3_OFFSET,
		0x03FFFFFFU, 0x03F7EF5EU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Configures the Read Channel Fabric interface width. 2'b11 : Reserved 2'b
    * 10 : 32-bit Fabric 2'b01 : 64-bit enabled 2'b00 : 128-bit enabled
    *  PSU_AFIFM4_AFIFM_RDCTRL_FABRIC_WIDTH                        0x1

    * Read Channel Control Register
    * (OFFSET, MASK, VALUE)      (0XFD3A0000, 0x00000003U ,0x00000001U)
    */
	PSU_Mask_Write(AFIFM4_AFIFM_RDCTRL_OFFSET, 0x00000003U, 0x00000001U);
/*##################################################################### */
    ...
    * Configures the Read Channel Fabric interface width. 2'b11 : Reserved 2'b
    * 10 : 32-bit Fabric 2'b01 : 64-bit enabled 2'b00 : 128-bit enabled
    *  PSU_AFIFM5_AFIFM_RDCTRL_FABRIC_WIDTH                        0x1

    * Read Channel Control Register
    * (OFFSET, MASK, VALUE)      (0XFD3B0000, 0x00000003U ,0x00000001U)
    */
	PSU_Mask_Write(AFIFM5_AFIFM_RDCTRL_OFFSET, 0x00000003U, 0x00000001U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Configures the Write Channel Fabric interface width. 2'b11 : Reserved 2'
    * b10 : 32-bit Fabric 2'b01 : 64-bit enabled 2'b00 : 128-bit enabled
    *  PSU_AFIFM4_AFIFM_WRCTRL_FABRIC_WIDTH                        0x1

    * Write Channel Control Register
    * (OFFSET, MASK, VALUE)      (0XFD3A0014, 0x00000003U ,0x00000001U)
    */
	PSU_Mask_Write(AFIFM4_AFIFM_WRCTRL_OFFSET, 0x00000003U, 0x00000001U);
/*##################################################################### */
    ...
    * Configures the Write Channel Fabric interface width. 2'b11 : Reserved 2'
    * b10 : 32-bit Fabric 2'b01 : 64-bit enabled 2'b00 : 128-bit enabled
    *  PSU_AFIFM5_AFIFM_WRCTRL_FABRIC_WIDTH                        0x1

    * Write Channel Control Register
    * (OFFSET, MASK, VALUE)      (0XFD3B0014, 0x00000003U ,0x00000001U)
    */
	PSU_Mask_Write(AFIFM5_AFIFM_WRCTRL_OFFSET, 0x00000003U, 0x00000001U);
/*##################################################################### */
