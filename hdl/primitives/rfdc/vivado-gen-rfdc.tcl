...
set_property -dict [ list \
    ...
    CONFIG.ADC_NCO_Freq00 {-0.39095} \
    CONFIG.ADC_NCO_Freq01 {-0.39095} \
    CONFIG.ADC_NCO_Freq02 {-0.39095} \
    CONFIG.ADC_NCO_Freq03 {-0.39095} \
    CONFIG.ADC_NCO_Freq12 {-0.39095} \
    CONFIG.ADC_NCO_Freq13 {-0.39095} \
    CONFIG.ADC_NCO_Freq20 {-0.39095} \
    CONFIG.ADC_NCO_Freq21 {-0.39095} \
    CONFIG.ADC_NCO_Freq22 {-0.39095} \
    CONFIG.ADC_NCO_Freq23 {-0.39095} \
    CONFIG.ADC_NCO_Freq32 {-0.39095} \
    CONFIG.ADC_NCO_Freq33 {-0.39095} \
...
set clk_ip_name clk_wiz
set clk_ip_part [lindex $argv 1]
set clk_ip_module ${clk_ip_name}_0
set clk_ip_dir managed_ip_project/managed_ip_project.srcs/sources_1/ip/$clk_ip_module
create_ip -name clk_wiz -vendor xilinx.com -library ip -version 6.0 \
    -module_name clk_wiz_0
set_property -dict [list \
    CONFIG.PRIM_IN_FREQ {225.0} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {90.0} \
    CONFIG.CLKIN1_JITTER_PS {44.44} \
    CONFIG.MMCM_DIVCLK_DIVIDE {5} \
    CONFIG.MMCM_CLKFBOUT_MULT_F {26.750} \
    CONFIG.MMCM_CLKIN1_PERIOD {4.444} \
    CONFIG.MMCM_CLKIN2_PERIOD {10.0} \
    CONFIG.MMCM_CLKOUT0_DIVIDE_F {13.375} \
    CONFIG.CLKOUT1_JITTER {141.138} \
    CONFIG.CLKOUT1_PHASE_ERROR {159.387} ] [get_ips $clk_ip_module]
generate_target all [get_files $clk_ip_dir/$clk_ip_module.xci]
create_ip_run [get_files -of_objects [get_fileset sources_1] $clk_ip_dir/$clk_ip_module.xci]
launch_runs ${clk_ip_module}_synth_1 -jobs 8
wait_on_run ${clk_ip_module}_synth_1
open_run ${clk_ip_module}_synth_1 -name ${clk_ip_module}_synth_1
write_vhdl -mode synth_stub $clk_ip_dir/${clk_ip_module}_stub.vhdl -force
